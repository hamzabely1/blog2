    ...
    <div class="container">
      <div class="row flex">
        <div class="qua col-md-3 d-flex flex-column prima">
            <br>
            <a href="post1admin.php"><div class="savoir">
            <p> plus</p>
          </div>
</a>
        </div>
        ...
        <div class="qua col-md-3 d-flex flex-column seconda">
          <br>
          <a href="post2admin.php"><div class="savoir">
            <p> plus</p>
          </div>
</a>
            <br>
        ...
        <div class="qua col-md-3 d-flex flex-column terza">
            ...
            <br>
            <a href="post3admin.php"><div class="savoir">
            <p> plus</p>
          </div>
</a>
        </div>
        <div class="qua col-md-3 d-flex flex-column ultima">
            <br>
            <a href="post4admin.php"><div class="savoir">
            <p> plus</p>
          </div>
</a>
        </div>
